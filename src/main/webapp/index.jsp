...
%>
<button type="button" style="background-color: #3498db; color: #fff; border: none; padding: 10px 20px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; cursor: pointer; transition: background-color 0.3s, color 0.3s;" onmouseover="this.style.backgroundColor='#5DADE2'; this.style.color='#333'" onmouseout="this.style.backgroundColor='#3498db'; this.style.color='#fff'" class="submit" onclick="window.location.href='<%= link %>';">
